...
return [
    ...
    */
    'user_models' => [
        'users' => \App\Models\Master\User\User::class,
    ],
    ...
    */
    'models' => [
        ...
        'role' => \App\Models\Master\Role\Role::class,

        'permission' => \App\Models\Master\Permission\Permission::class,

        /**
         * Will be used only if the teams functionality is enabled.
         */
        'team' => \App\Models\Master\Team::class,
    ],
