...
class StudyDegreeTest extends Base
{
    public function setUp() : void
    {
        $this->modelName = 'study-degree';
        $this->modelClass = StudyDegree::class;
        $this->modelTranslationClass = StudyDegreeTranslation::class;
        ...
        $this->rawData = [
            'translations' => [
                [
                    'language_code' => 'ru',
                    'name' => 'Test study_degree ru',
                ],
                [
                    'language_code' => 'uz',
                    'name' => 'Test study_degree uz',
                ],
                [
                    'language_code' => 'uzc',
                    'name' => 'Test study_degree uzc',
                ]
            ],
        ];
