...
class SpecialityTypeTest extends Base
{
    public function setUp() : void
    {
        $this->modelName = 'specialty-type';
        $this->modelClass = SpecialtyType::class;
        $this->modelTranslationClass = SpecialtyTypeTranslation::class;
        ...
        $this->rawData = [
            ...
            'translations' => [
                [
                    'language_code' => 'ru',
                    'name' => 'Test specialty_type ru',
                ],
                [
                    'language_code' => 'uz',
                    'name' => 'Test specialty_type uz',
                ],
                [
                    'language_code' => 'uzc',
                    'name' => 'Test specialty_type uzc',
                ]
            ],
        ];
