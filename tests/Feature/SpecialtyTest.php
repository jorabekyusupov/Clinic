...
class SpecialtyTest extends Base
{
    public function setUp() : void
    {
        $this->modelName = 'specialty';
        $this->modelClass = Specialty::class;
        $this->modelTranslationClass = SpecialtyTranslation::class;
        ...
        $this->rawData = [
            ...
            'translations' => [
                [
                    'language_code' => 'ru',
                    'name' => 'Test specialty ru',
                ],
                [
                    'language_code' => 'uz',
                    'name' => 'Test specialty uz',
                ],
                [
                    'language_code' => 'uzc',
                    'name' => 'Test specialty uzc',
                ]
            ],
        ];
    ...
    public function test_return_validation_error_when_required_fields_not_sent_on_create()
    {
        ...
        unset($rawData['specialty_type_id']);
    ...
    protected function createModels($count = 1){
        ...
        SpecialtyTypeTranslation::factory()->create(['specialty_type_id' => $specialtyType->id, 'language_code' => 'uz']);
        SpecialtyTypeTranslation::factory()->create(['specialty_type_id' => $specialtyType->id, 'language_code' => 'uzc']);
        SpecialtyTypeTranslation::factory()->create(['specialty_type_id' => $specialtyType->id, 'language_code' => 'ru']);

        $params['specialty_type_id'] = $specialtyType->id;
    ...
    private function prepareDataForUpdate($model){
        ...
        $rawData = [
            'specialty_type_id' => $model->specialty_type_id,
