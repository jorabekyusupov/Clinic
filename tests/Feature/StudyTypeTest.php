...
class StudyTypeTest extends Base
{
    public function setUp() : void
    {
        $this->modelName = 'study-type';
        $this->modelClass = StudyType::class;
        $this->modelTranslationClass = StudyTypeTranslation::class;
        ...
        $this->rawData = [
            'translations' => [
                [
                    'language_code' => 'ru',
                    'name' => 'Test study_type ru',
                ],
                [
                    'language_code' => 'uz',
                    'name' => 'Test study_type uz',
                ],
                [
                    'language_code' => 'uzc',
                    'name' => 'Test study_type uzc',
                ]
            ],
        ];
