...
class UniversityTest extends Base
{
    public function setUp() : void
    {
        $this->modelName = 'university';
        $this->modelClass = University::class;
        $this->modelTranslationClass = UniversityTranslation::class;
        ...
        $this->rawData = [
            'translations' => [
                [
                    'language_code' => 'ru',
                    'name' => 'Test university ru',
                ],
                [
                    'language_code' => 'uz',
                    'name' => 'Test university uz',
                ],
                [
                    'language_code' => 'uzc',
                    'name' => 'Test university uzc',
                ]
            ],
        ];
