...
class WeeklyScheduleTest extends Base
{
    public function setUp() : void
    {
        $this->modelName = 'weekly-schedule';
        $this->modelClass = WeeklySchedule::class;
        $this->modelTranslationClass = WeeklyScheduleTranslation::class;
        ...
        $this->indexStructure = [
            '*' => [
                ...
                'deleted_by',
                'deleted_at',
                'weekly_schedule_translation_id',
                'language_code',
                'name',
            ]
        ];
        ...
        $this->rawData = [
            ...
            'translations' => [
                [
                    'language_code' => 'ru',
                    'name' => 'Test weekly_schedule ru',
                ],
                [
                    'language_code' => 'uz',
                    'name' => 'Test weekly_schedule uz',
                ],
                [
                    'language_code' => 'uzc',
                    'name' => 'Test weekly_schedule uzc',
                ]
            ],
        ];
